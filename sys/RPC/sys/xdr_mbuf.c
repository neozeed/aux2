#ifndef lint	/* .../sys/RPC/sys/xdr_mbuf.c */
#define _AC_NAME xdr_mbuf_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1983-87 Sun Microsystems Inc., All Rights Reserved.  {Apple version 1.3 88/05/22 19:09:23}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.3 of xdr_mbuf.c on 88/05/22 19:09:23 1.1 86/02/03 Copyr 1984 Sun Micro";
#endif		/* _AC_HISTORY */
#endif		/* lint */
