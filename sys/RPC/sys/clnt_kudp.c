#ifndef lint	/* .../sys/RPC/sys/clnt_kudp.c */
#define _AC_NAME clnt_kudp_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1983-87 Sun Microsystems Inc., All Rights Reserved.  {Apple version 2.1 89/10/16 09:46:42}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 2.1 of clnt_kudp.c on 89/10/16 09:46:42";
#endif		/* _AC_HISTORY */
#endif		/* lint */
...
call_again:
	...
	while (p->cku_flags & CKU_BUFBUSY) {
		 ...
		 * we are waiting.
		 */
		timeout(wakeup, (caddr_t)&p->cku_outbuf, v.v_hz);
