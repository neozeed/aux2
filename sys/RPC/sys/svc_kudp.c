#ifndef lint	/* .../sys/RPC/sys/svc_kudp.c */
#define _AC_NAME svc_kudp_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1983-87 Sun Microsystems Inc., All Rights Reserved.  {Apple version 2.1 89/10/16 09:47:57}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 2.1 of svc_kudp.c on 89/10/16 09:47:57";
#endif		/* _AC_HISTORY */
#endif		/* lint */
