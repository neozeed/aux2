#ifndef lint	/* .../sys/PAGING/os/sem.c */
#define _AC_NAME sem_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 2.1 89/10/13 12:07:05}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 2.1 of sem.c on 89/10/13 12:07:05";
#endif		/* _AC_HISTORY */
#endif		/* lint */
