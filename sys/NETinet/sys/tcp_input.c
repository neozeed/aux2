#ifndef lint	/* .../sys/NETinet/sys/tcp_input.c */
#define _AC_NAME tcp_input_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1987 Apple Computer, Inc., 1983-87 Sun Microsystems Inc., All Rights Reserved.  {Apple version 1.10 88/12/26 11:35:34}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.10 of tcp_input.c on 88/12/26 11:35:34";
#endif		/* _AC_HISTORY */
#endif		/* lint */
 ...
 *
 *	@(#)tcp_input.c	7.9 (Berkeley) 7/2/87
 */
