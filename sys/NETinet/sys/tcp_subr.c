#ifndef lint	/* .../sys/NETinet/sys/tcp_subr.c */
#define _AC_NAME tcp_subr_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1987 Apple Computer, Inc., 1983-87 Sun Microsystems Inc., All Rights Reserved.  {Apple version 1.5 88/05/22 20:22:52}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.5 of tcp_subr.c on 88/05/22 20:22:52";
#endif		/* _AC_HISTORY */
#endif		/* lint */
 ...
 *
 *	@(#)tcp_subr.c	7.9 (Berkeley) 7/3/87
 */
