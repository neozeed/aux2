#ifndef lint	/* .../sys/NETinet/sys/tcp_output.c */
#define _AC_NAME tcp_output_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1987 Apple Computer, Inc., 1983-87 Sun Microsystems Inc., All Rights Reserved.  {Apple version 1.4 88/05/22 20:22:39}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.4 of tcp_output.c on 88/05/22 20:22:39";
#endif		/* _AC_HISTORY */
#endif		/* lint */
 ...
 *
 *	@(#)tcp_output.c	7.8 (Berkeley) 7/3/87
 */
