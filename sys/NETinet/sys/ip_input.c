#ifndef lint	/* .../sys/NETinet/sys/ip_input.c */
#define _AC_NAME ip_input_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1987 Apple Computer, Inc., 1983-87 Sun Microsystems Inc., All Rights Reserved.  {Apple version 1.6 88/08/10 16:41:47}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.6 of ip_input.c on 88/08/10 16:41:47";
#endif		/* _AC_HISTORY */
#endif		/* lint */
