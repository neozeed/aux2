#ifndef lint	/* .../sys/NETinet/sys/in.c */
#define _AC_NAME in_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1987 Apple Computer, Inc., 1983-87 Sun Microsystems Inc., All Rights Reserved.  {Apple version 2.1 89/10/14 14:48:36}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 2.1 of in.c on 89/10/14 14:48:36";
#endif		/* _AC_HISTORY */
#endif		/* lint */
