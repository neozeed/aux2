...
#define _AC_NO_MAIN "@(#) Copyright (c) 1987 Apple Computer, Inc., 1983-87 Sun Microsystems Inc., All Rights Reserved.  {Apple version 2.1 89/10/14 14:49:36}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 2.1 of udp_usrreq.c on 89/10/14 14:49:36";
#endif		/* _AC_HISTORY */
#endif		/* lint */
...
int udpbigpkt = 4064;
char *bigpktp = (char *)&udpstat.udps_bigpkt;
...
int	udp_recvspace = 4 * (9000+sizeof(struct sockaddr_in)); /* 4 8K dgrams */
