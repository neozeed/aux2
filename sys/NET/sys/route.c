#ifndef lint	/* .../sys/NET/sys/route.c */
#define _AC_NAME route_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1987 Apple Computer, Inc., 1983-87 Sun Microsystems Inc., All Rights Reserved.  {Apple version 2.1 89/10/13 19:46:15}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 2.1 of route.c on 89/10/13 19:46:15";
#endif		/* _AC_HISTORY */
#endif		/* lint */

#define _AC_MODS
/*	@(#)route.c 1.1 86/02/03 SMI; from UCB 6.3 83/12/15	*/
/*	@(#)route.c	2.1 86/04/15 NFSSRC */
